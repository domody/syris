...
function getPromptUrl(baseUrl: string, url: string) {
  return `${baseUrl}?q=${encodeURIComponent(
    `I'm reading the SYRIS docs page: ${url}
...
export function DocsCopyPage({ page, url }: { page: string; url: string }) {
  ...
  return (
    <div className="bg-secondary group/buttons flex relative rounded-lg *:[[data-slot=button]]:focus-visible:relative *:[[data-slot=button]]:focus-visible:z-10">
      <Button
        variant="secondary"
        size="sm"
      ...
      <Separator orientation="vertical" className={"!bg-foreground/5 absolute top-1 right-8 z-0 !h-6 peer-focus-visible:opacity-0 sm:right-7 sm:!h-5"} />
      <DropdownMenu>
