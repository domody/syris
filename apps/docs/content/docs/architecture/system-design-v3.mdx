...
<Alert>
  ...
  <AlertDescription>
    This document is a consolidated architecture draft assembled from prior
    system requirements and iterative design discussions. It should be treated
    as a living baseline and updated as implementation realities emerge.
  </AlertDescription>
</Alert>
...
- `task_id`, `created_at`, `status` (pending / running / paused / succeeded / failed / ca nceled)
