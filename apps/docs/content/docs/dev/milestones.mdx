...
- [dev/repo-structure](https://docs.syris.uk/docs/dev/repo-structure)
- [dev/testing-strategy](https://docs.syris.uk/docs/dev/testing-strategy)
- [dev/outstanding-decisions](https://docs.syris.uk/docs/dev/outstanding-decisions)
- [architecture/component-map](https://docs.syris.uk/docs/architecture/component-map)
- [dev/implementation-design](https://docs.syris.uk/docs/dev/implementation-design)
- [dev/fast-path-intents](https://docs.syris.uk/docs/dev/fast-path-intents)
    ## Related
