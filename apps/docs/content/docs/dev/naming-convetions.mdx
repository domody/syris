...
description: Naming, module organisation, and codebase norms for consistency and long-term maintainability.
---
...
Use canonical terms from the [Glossary](/docs/overview/glossary):
