...
from syris_core.types.task import Automation, PromptAutomation, PlanAutomation, TimerAutomation, AlarmAutomation
...
SYSTEM_DIAGNOSTIC_PLAN = Plan(
    ...
    steps=[
        ...
        PlanStep(
            id="get_uptime",
            tool="system.get_uptime",
            arguments={}
        ),
        PlanStep(
            id="get_os_info",
            tool="system.get_os_info",
            arguments={}
        ),
        PlanStep(
            id="get_cpu_usage",
            tool="hardware.get_cpu_usage",
            arguments={}
        ),
        PlanStep(
            id="get_disk_usage",
            tool="hardware.get_disk_usage",
            arguments={}
        ),
        PlanStep(
            id="get_memory_usage",
            tool="hardware.get_memory_usage",
            arguments={}
        ),
    ]
)
